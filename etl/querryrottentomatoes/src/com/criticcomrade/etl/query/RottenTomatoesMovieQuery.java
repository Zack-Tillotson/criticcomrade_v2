...
import com.criticcomrade.api.data.MoviePerson;
import com.criticcomrade.api.data.Review;
...
public class RottenTomatoesMovieQuery extends DataItem {
    ...
    public Collection<Attribute> getDirectAttributes() {
        ...
        attrs
                .add(new Attribute(AttributeConstants.MOVIE_URL_TITLE,
                        movie.links.alternate.split("/m/")[1].split("/")[0]));
    ...
    protected Collection<DataItem> buildSubItems() {
        ...
        // Release Dates
        if (((movie.release_dates != null) && (movie.release_dates.dvd != null))
                || (movie.release_dates.theater != null)) {
            ...
            dataItems.add(new DataItem(AttributeConstants.REVIEW) {
                ...
                public Collection<Attribute> getDirectAttributes() {
                    ...
                    if (review.freshness != null) {
                        attrs.add(new Attribute(AttributeConstants.REVIEW_IS_POSITIVE,
                                review.freshness.equals("fresh") ? "TRUE" : "FALSE"));
                    }
                    return attrs;
                }
    ...
    /**
     * Get the approximate number of api calls required to do this query. It will be 1 for the movie, then 1 for each
     * page of reviews
     * 
