...
public class RtQueueDao extends AbstractDao {
    ...
    /**
     * Will return a movie with at least one review which is active since the start of the period, but not scraped since
     * the end
     * 
     * @param start
     * @param end
     ...
     * 
     * @param stale
     *            The date movies should have been last queried before to be considered stale
     * @return
     */
